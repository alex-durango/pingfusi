...
pingfusi studio  [ping_id ...]          LOCAL RESULTS VIEWER: fetches a
                                        ...
                                        event seek). Machine runs are labeled as such: a
                                        RUN is never a review round — no reviewer, no
                                        filing, no charge. Its RECORDING may still be
                                        filed as ordinary video stimulus, told to the
                                        reviewer as machine-played; the run's own
                                        findings never travel with it
