...
- **Remote (default)** — rounds go to the pingfusi review service over a public tunnel and
  bill small credits (`pingfusi setup` creates the login). Independent verdicts.
...
│   │                  it's recorded (a dead tunnel burns a review round — hn round 1)
