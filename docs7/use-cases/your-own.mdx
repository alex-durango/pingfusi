---
title: "Make your own job (TEMPLATE)"
sidebarTitle: "Make your own job"
---

A job is a rules-file your agent follows: it names a judgment a machine cannot
verify, and pins it to the core API ([docs/CORE.md](/develop/core) has the
contracts). Start by running it as [Review anything](/use-cases/review-anything)
...
[../copy-anything/README.md](/use-cases/copy-anything) for the packaged version
