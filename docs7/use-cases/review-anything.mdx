---
title: "Review anything — a verdict on whatever you publish"
sidebarTitle: "Review anything"
---
...
- You are prototyping a NEW kind of review — run it generic first, specialize after
  it proves out ([Make your own](/use-cases/your-own) is the packaging step).
- The work needs a real DONE/NOT-DONE from someone who isn't its author.

**The contract** (the doctrine every job inherits — details in [docs/CORE.md](/develop/core)):
...
worked example in [Make your own](/use-cases/your-own) is a complete recipe.
