---
title: "Quick question — ask a human one thing"
sidebarTitle: "Quick question"
---
...
verdict. When the ask is "is this DONE?", that is the [Review anything](/use-cases/review-anything)
...
question: publish it (`pingfusi publish`) and file [Review anything](/use-cases/review-anything)
...
API: `core.ping` / `core.pingResult` ([docs/CORE.md](/develop/core)). `core.ping`
...
**Its routing skill:** [`pingfusi-review`](/skills/pingfusi-review), which
