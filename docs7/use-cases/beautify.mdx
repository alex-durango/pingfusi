---
title: "Website Beautification — use case #2"
sidebarTitle: "Beautify"
---
...
**Its skill:** [`beautify-with-pingfusi`](/skills/beautify-with-pingfusi),
...
[`beautify-with-pingfusi` skill](/skills/beautify-with-pingfusi). Core's
wire, caps, publish-before-review rule, comment envelope, and exact-verdict handling are
documented in [docs/CORE.md](/develop/core).
