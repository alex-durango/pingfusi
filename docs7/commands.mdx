...
pingfusi publish-build <game.zip> --platform windows|macos
                                        ...
                                        platform:. Hosted builds are KEPT UNTIL YOU DELETE
                                        THEM (`--expires-in-hours <n>` opts one into being
                                        reaped instead), and a handful per account —
                                        `pingfusi builds` shows what you hold and
                                        ...
                                        playtest instead.
                                        (`--name`, `--expires-in-hours`, `--record`, and
                                        `--json` available)
